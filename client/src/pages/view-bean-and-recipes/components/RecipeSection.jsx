      ...
      <div className="relative px-4 pt-8 pb-4 mb-4 bg-white shadow-sm rounded-md w-full transition-all">
        ...
        <div className="flex">
          <div className="flex flex-col justify-between w-1/4 h-auto px-4 border-r">
            ...
            <h3 className="text-xl my-2">{method ? rangeList['method_range']['id-' + method]['label'] : '-'}</h3>
          ...
          <div className="flex flex-col justify-between relative w-1/4 h-auto px-4 border-r">
            ...
            <div className="flex justify-end flex-wrap">
              ...
              {grinder 
                  ? 
              <span className="basic-chip">{rangeList['grinder_range']['id-' + grinder]['label']}</span> 
                  : 
              null}
            </div>
          </div>
          <div className="flex flex-col justify-between relative w-1/4 h-auto px-4 border-r">
            ...
            <div className="flex justify-end flex-wrap">
              ...
              {water 
                  ? 
              <span className="basic-chip">{rangeList['water_range']['id-' + water]['label']}</span> 
                  : 
              null}
            </div>
          </div>
          ...
          >
            <div className="flex my-8">
              <div className="w-1/2 px-6 mt-auto mb-0">
                ...
                <div className="coffee-detail-section">
                  <label>Grinder: </label>
                  <p>{grinder ? rangeList['grinder_range']['id-' + grinder]['label'] : '-'}</p>
                </div>
                <div className="coffee-detail-section">
                ...
                <div className="coffee-detail-section">
                  <label>Water: </label>
                  <p>{water ? rangeList['water_range']['id-' + water]['label'] : '-'}</p>
                </div>
                <div className="coffee-detail-section">
              ...
              {Object.keys(palate).length > 0 
                ...
                <ChartRadarTaste 
                  ...
                  labels={Object.keys(palate).map(palateId => { return rangeList['palate_range']['id-' + palateId]['label'] })}
