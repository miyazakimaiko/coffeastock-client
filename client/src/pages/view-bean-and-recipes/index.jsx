...
const ViewBeanAndRecipes = () => {
            ...
            <TooltipLeft category="blend" itemId={beanId} tooltipText={text}>            
              <div 
                ...
                <div className="text-right">
                  {`${unescapeHtml(beanList?.find(d => d.bean_id == beanId)['label'])}: ${ratio}%`}
                </div>
                <FaInfoCircle className="h-4 w-4 ml-2 flex-shrink-0" />
              </div>
            </TooltipLeft>
  ...
  if (beanListIsLoading || targetBeanIsLoading || rangeListIsLoading) {
    return 'Loading...'
  }
          ...
          <div className="relative bg-white p-2 py-12 rounded-lg shadow-sm">
                  ...
                  content={
                    <div className="flex">
                      ...
                      <span className="ml-2">
                        ...
                        targetBean['grade'] !== "" ? `(${targetBean['grade']}/100)` : '-'}
                      </span>
                    </div>
                  }
                />
                  ...
                  content={
                    <div className="flex">
                      ...
                      <span className="ml-2">
                        ...
                        targetBean['roast_level'] !== "" ? `(${targetBean['roast_level']}/10)` : '-'}
                      </span>
                    </div>
                  }
                />
            ...
            { targetBean['memo'] !== null && targetBean['memo'] !== ""
              ...
              <div className="px-6 pt-4">
                ...
                <div className="inline-block">{unescapeHtml(targetBean['memo'])}</div>
              </div>
                : 
              null
            }
