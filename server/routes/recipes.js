...
module.exports = (app) => {
    ...
    app.get("/api/v1/bean/:productid/recipes", async (req, res, next) => {
        try {
    ...
    app.post("/api/v1/bean/:productid/recipe/:recipeid", async (req, res, next) => {
        try {
            const results = await db.query(`
            UPDATE recipes 
            SET 
    ...
    // delete a recipe
    app.delete("/api/v1/bean/:productid/recipe/:recipeid", async (req, res, next) => {
        try {
            const results = await db.query(`
